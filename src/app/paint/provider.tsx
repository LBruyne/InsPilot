...
import {generateMockDesignCreatives} from "@/mocks/utils";
...
export const ADD_SCHEME = "ADD_SCHEME", SWITCH_STAGE = "SWITCH_STAGE", ADD_DESIGN_TEXT = "ADD_DESIGN_TEXT",
    ...
    NEXT_CREATIVE = "NEXT_CREATIVE", CLEAR_DESIGN_TEXTS = "CLEAR_DESIGN_TEXTS", UPDATE_SELECTED_SCHEMES = "UPDATE_SELECTED_SCHEMES",
    UPDATE_CURRENT_SCHEME = "UPDATE_CURRENT_SCHEME"
export type PaintAction = { type: string; payload: any }

const initialState: PaintState = {
    selectedSchemes: [],
    designCreatives: generateMockDesignCreatives(),
